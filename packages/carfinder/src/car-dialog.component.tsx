  ...
  const handleTextFieldChange = (e: any) => {
    switch (e.target.id) {
      ...
      case "form-car-gearbox":
        ...
        break;
      case "form-car-ensurance-0":
        setCar({
          ...car,
          ensurance: [e.target.value, car.ensurance[1], car.ensurance[2]],
        });
        break;
      case "form-car-ensurance-1":
        setCar({
          ...car,
          ensurance: [car.ensurance[0], e.target.value, car.ensurance[2]],
        });
        break;
      case "form-car-ensurance-2":
        setCar({
          ...car,
          ensurance: [car.ensurance[0], car.ensurance[1], e.target.value],
        });
        break;
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        ...
        />
        <TextField
          id="form-car-ensurance-0"
          margin="dense"
          label="Helförsäkring"
          fullWidth
          value={car.ensurance[0]}
          onChange={handleTextFieldChange}
        />
        <TextField
          id="form-car-ensurance-1"
          margin="dense"
          label="Halvförsäkring"
          fullWidth
          value={car.ensurance[1]}
          onChange={handleTextFieldChange}
        />
        <TextField
          id="form-car-ensurance-2"
          margin="dense"
          label="Trafikförsäkring"
          fullWidth
          value={car.ensurance[2]}
          onChange={handleTextFieldChange}
        />
        <TextField
